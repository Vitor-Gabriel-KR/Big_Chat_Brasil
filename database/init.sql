...
CREATE TABLE IF NOT EXISTS messages (
  ...
  cost NUMERIC(12, 2) NOT NULL CHECK (cost IN (0, 0.25, 0.50)),
  status message_status NOT NULL DEFAULT 'queued',
  sender message_sender NOT NULL DEFAULT 'company',
...
CREATE INDEX IF NOT EXISTS idx_messages_conversation_read_at ON messages(conversation_id, read_at);
...
ON CONFLICT (id) DO NOTHING;
    ...
    VALUES
      ('88888888-8888-4888-8888-888888888888', '44444444-4444-4444-8444-444444444444', '11111111-1111-4111-8111-111111111111', 'Preciso confirmar o envio da segunda via.', 'normal', 0.25, 'queued', 'company', NOW() - INTERVAL '25 minutes', NULL, NULL, NOW() - INTERVAL '25 minutes'),
      ('99999999-9999-4999-8999-999999999999', '55555555-5555-4555-8555-555555555555', '11111111-1111-4111-8111-111111111111', 'Chamar o cliente principal para validação ainda hoje.', 'urgent', 0.50, 'queued', 'company', NOW() - INTERVAL '12 minutes', NULL, NULL, NOW() - INTERVAL '12 minutes'),
      ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa', '66666666-6666-4666-8666-666666666666', '22222222-2222-4222-8222-222222222222', 'Mensagem de rotina para atualização de status.', 'normal', 0.25, 'sent', 'company', NOW() - INTERVAL '2 hours', NOW() - INTERVAL '2 hours', NOW() - INTERVAL '90 minutes', NOW() - INTERVAL '2 hours'),
      ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb', '77777777-7777-4777-8777-777777777777', '33333333-3333-4333-8333-333333333333', 'Retorno urgente aguardando aceite.', 'urgent', 0.50, 'queued', 'company', NOW() - INTERVAL '5 minutes', NULL, NULL, NOW() - INTERVAL '5 minutes')
    ON CONFLICT (id) DO NOTHING;
